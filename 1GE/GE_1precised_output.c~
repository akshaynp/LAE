...
int main()
{
	...
	input_ptr = fopen("in_random_matrix_500*500.txt","r");
        output_ptr = fopen("out_random_matrix_500*500.txt","w");
	//input_ptr = fopen("in_random_matrix_2000*2000.txt","r");
        //output_ptr = fopen("out_random_matrix_2000*2000.txt","w");
...
////////////////////////////////Error Identification///////////////////////////////////////////
	...
	fprintf(output_ptr,"\n\nTotal time required to execute is = %f sec\n",total_time);
